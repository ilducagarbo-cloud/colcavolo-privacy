...
 
 
Informativa sulla Privacy di ColCavolo
 
...
Non vendiamo, scambiamo o trasferiamo a terze parti nessuna tua informazione personale. Non utilizziamo servizi di analisi esterni che raccolgono dati identificativi.
 
3. Esclusione di responsabilità medica
L'app fornisce indicazioni nutrizionali a scopo puramente informativo. Queste informazioni non sostituiscono in alcun modo il parere, la diagnosi o il trattamento di un medico professionista. Consulta sempre un medico per qualsiasi domanda riguardante una condizione medica o cambiamenti alla tua dieta.
 
4. Modifiche all'informativa
Eventuali aggiornamenti alla presente informativa saranno pubblicati su questa pagina. L'uso continuato dell'app costituisce accettazione dei termini aggiornati.
 
5. Contatti
Per qualsiasi domanda relativa alla tua privacy, puoi contattarci all'indirizzo: lucadigarbo@gmail.com
